...
@class DVTDelayedInvocation, DVTStackBacktrace, IDEAppIDFeatureCoordinator, NSArray, NSString, Xcode3TargetBuildSettingsCoordinator, Xcode3TargetEntitlementsCoordinator<IDEProjectItemModelEntitlementsCoordinator>, Xcode3TargetInfoPlistCoordinator, Xcode3TargetLinkedFrameworksCoordinator;
