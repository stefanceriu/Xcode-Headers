...
@class DVTFilePath, IDEAppIDFeatures, NSArray, NSDictionary, NSNumber, NSString;
...
- (id)initWithPath:(id)arg1 infoDictionary:(id)arg2 canHaveProvisioningProfile:(BOOL)arg3 hasProvisioningProfile:(BOOL)arg4 team:(id)arg5 appID:(id)arg6 entitlements:(id)arg7 archivedUserEntitlements:(id)arg8 childItems:(id)arg9;
- (id)init;
