...
#import "IDEProvisioningLedgerDelegate.h"

@class DVTStackBacktrace, IDEActivityLogSection, IDELogStore, IDEProvisioningLogDVTLogAspectListener, IDETypeIdentifier, IDEWorkspace, NSArray, NSMutableDictionary, NSMutableString, NSObject<OS_dispatch_queue>, NSString;
