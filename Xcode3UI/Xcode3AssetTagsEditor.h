...
@class DVTBorderedView, DVTDelayedInvocation, DVTGradientImageButton, DVTMutableOrderedDictionary, DVTObservingToken, DVTOutlineView, DVTPerformanceMetric, DVTSearchField, DVTSourceExpression, IDEBuildOperation, NSArray, NSButton, NSLayoutConstraint, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, PBXProject, Xcode3ProjectEditor, Xcode3Target;
