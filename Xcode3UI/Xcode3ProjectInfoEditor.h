...
@class DVTBorderedView, DVTGradientImageButton, DVTGradientImagePopUpButton, DVTImageAndTextCell, DVTLocale, DVTLozengeTextField, DVTObservingToken, DVTOutlineViewWithCustomGridDrawing, DVTPerformanceMetric, DVTSourceExpression, DVTStackView_ML, DVTTableView, IDECapsuleListView, NSArray, NSButton, NSComboBox, NSMenu, NSMutableArray, NSMutableDictionary, NSPopUpButton, NSString, NSTextField, NSTextFieldCell, NSTimer, NSView, PBXProject, Xcode3ProjectEditor;
