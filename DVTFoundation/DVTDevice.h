...
@class DTXChannel, DVTDeviceType, DVTDispatchLock, DVTExtension, DVTPlatform, NSArray, NSData, NSError, NSMutableArray, NSMutableSet, NSObject<OS_dispatch_queue>, NSOrderedSet, NSSet, NSString, NSURL;
