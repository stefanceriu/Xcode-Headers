...
@class DVTStackBacktrace, IBAbstractPlatformToolExecutionContext, IBMessageSendChannel, IBPlatformToolLaunchContext, NSMutableArray, NSObject<OS_dispatch_queue>, NSPipe, NSString;
