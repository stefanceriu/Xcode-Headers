...
#import "IDEToyboxDelegate.h"

@class DVTFilePath, DVTMapTable, IDEPlaygroundDocumentSharedContext, IDEToybox, NSArray, NSDictionary, NSError, NSMutableArray, NSOperationQueue, NSString, NSURL, NSUUID;
