...
- (void)unmodifiedAndUpstreamContentsOfFile:(NSString *)arg1 inWorkingCopy:(DVTSourceControlWorkingCopy *)arg2 completionBlock:(void (^)(NSString *, NSString *, NSError *))arg3;
