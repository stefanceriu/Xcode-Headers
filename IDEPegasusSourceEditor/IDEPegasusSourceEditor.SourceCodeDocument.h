...
@interface IDEPegasusSourceEditor.SourceCodeDocument : IDEEditorDocument <IDESourceCodeGenerationDestination, DVTSourceLanguagePrimaryCompletionStrategy, IDESourceCodeDocument, IDEDocumentStructureProviding, DVTTextFindable, DVTTextReplacable, IDEMediaLibraryDelegate, DVTSourceModelProvider>
{
