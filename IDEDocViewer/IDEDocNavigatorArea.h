...
@class DVTBorderedView, DVTExtension, DVTObservingToken, DVTReplacementView, DVTScopeBarView, IDEDocContentAreaViewController, NSArrayController, NSLayoutConstraint, NSStackView, NSString;
...
@interface IDEDocNavigatorArea : IDEViewController <DVTReplacementViewDelegate>
{
    ...
    DVTBorderedView *_navigatorRightSideSeparatorView;
}
...
@property __weak DVTBorderedView *navigatorRightSideSeparatorView; // @synthesize navigatorRightSideSeparatorView=_navigatorRightSideSeparatorView;
