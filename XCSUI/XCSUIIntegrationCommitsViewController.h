...
@class DVTLozengeTextField, DVTReplacementView, DVTScrollView, NSArray, NSError, NSMapTable, NSString, NSTableView, NSTextField, NSView, XCSContributor, XCSIntegration, XCSUIInsetHorizontalDividerLine, XCSUIProgressReplacementView, _XCSUIAllCommittersBadgeView;
