...
#import <IDESourceControlUI/IDESourceControlUI.WorkingCopyHolder.h>

@class NSArray, NSDictionary, NSString;

@interface IDESourceControlUI.ManagedWorkingCopyHolder : IDESourceControlUI.WorkingCopyHolder
{
}
