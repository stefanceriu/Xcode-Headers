...
+ (id)simulatedNavigationBarMetricsWithStyle:(long long)arg1 translucent:(BOOL)arg2 prompt:(BOOL)arg3 tintColor:(struct NSColor *)arg4 barTintColor:(struct NSColor *)arg5;
+ (id)defaultMetrics;
