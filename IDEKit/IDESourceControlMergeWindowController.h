...
@class IDESourceControlMergeDataSource, IDEWorkspaceDocument, NSString;

@interface IDESourceControlMergeWindowController : IDESourceControlConflictResolutionWindowController <IDEWorkspaceDocumentProvider>
{
...
- (id)mergeOperationInfoForWorkingTree:(id)arg1;
