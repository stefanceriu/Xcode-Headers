...
#import <IDEKit/IDESourceControlOperationViewController-Protocol.h>

@class DVTSourceControlWorkingCopy, NSString;
@protocol IDESourceControlOperationViewDelegate;

@interface _TtC6IDEKit42IDESourceControlStatusUpdateViewController : DVTViewController <IDESourceControlOperationViewController>
{
