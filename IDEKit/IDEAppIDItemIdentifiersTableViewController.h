...
@class DVTBorderedView, DVTGradientImageButton, DVTObservingToken, DVTStackView_ML, DVTTableView, IDEAppIDItemIdentifiersItemModelSet, NSArray, NSMutableArray, NSScrollView, NSString;
