...
@class DVTBorderedView, DVTDelayedInvocation, IDEProjectItemHeaderView, IDEProjectItemModel, NSDictionary, NSImage, NSMutableArray, NSString, NSView;
...
- (void)capsuleView:(id)arg1 themeChanged:(id)arg2;
