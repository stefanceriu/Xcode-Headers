...
@interface IDESourceControlCredentialViewController : DVTViewController <IDESourceControlSSHKeyCredentialViewDelegate>
{
    ...
    NSString *_passwordFieldStringValue;
    NSString *_usernameFieldStringValue;
...
@property(retain) NSString *usernameFieldStringValue; // @synthesize usernameFieldStringValue=_usernameFieldStringValue;
@property(retain) NSString *passwordFieldStringValue; // @synthesize passwordFieldStringValue=_passwordFieldStringValue;
