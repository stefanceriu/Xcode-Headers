...
@class DVTDelayedInvocation, DVTNotificationToken, DVTObservingToken, IDEBuildTimeStatistics, IDESourceControlUIHandler, NSArray, NSDictionary, NSMenuItem, NSMutableDictionary, NSString;
