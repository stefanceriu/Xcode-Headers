...
@class DVTBorderedView, DVTObservingToken, DVTStackBacktrace, IDELocalizationImportAction, IDELocalizationImporter, IDENavigableItem, IDENavigableItemAsyncFilteringCoordinator, IDENavigatorDataCell, IDEReviewFilesViewController, NSMutableDictionary, NSMutableSet, NSString;
