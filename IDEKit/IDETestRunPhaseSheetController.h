...
@class DVTBorderedView, DVTChoice, DVTGradientImageButton, DVTNotificationToken, DVTObservingToken, DVTOutlineViewWithCustomGridDrawing, DVTSearchField, DVTTabChooserView, IDEArgumentsCapsuleSheetController, IDECapsuleListView, IDEDebuggerSpecifier, IDEEnvironmentVariablesCapsuleSheetController, IDEScheme, IDESimulateLocationMenuController, IDETestSchemeAction, IDEWorkspace, NSArray, NSButton, NSButtonCell, NSLayoutConstraint, NSMatrix, NSMutableArray, NSPopUpButton, NSStackView, NSString, NSTabView, NSTableColumn, NSTextField, NSView;
