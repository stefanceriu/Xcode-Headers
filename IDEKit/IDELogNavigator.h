...
@class DVTBorderedView, DVTObservingToken, DVTScopeBarView, DVTScrollView, IDELogNavigatorRootItem, NSButton, NSDictionary, NSImage, NSLayoutConstraint, NSMutableArray, NSMutableSet, NSPredicate, NSSet, NSString;
