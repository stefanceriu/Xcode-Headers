...
@class DVTCrashPointSource, DVTObservingToken, DVTProduct, DVTUserDefaultsLeastRecentlyUsedCache, IDENavigableItem, IDENavigableItemCoordinator, IDEPathControl, NSArray, NSButton, NSError, NSLayoutConstraint, NSString;
