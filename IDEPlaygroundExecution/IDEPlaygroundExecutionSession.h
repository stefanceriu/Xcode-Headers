...
#import "IDEPlaygroundDataHandlerDelegate.h"
#import "IDEPlaygroundDeviceOwner.h"

@class DVTDisallowFinishToken, DVTDispatchLock, DVTNotificationToken, DVTObservingToken, DVTPerformanceMetric, DVTPlaygroundCommunicationListener, IDEConsoleAdaptor, IDEPlaygroundDataHandler, IDEPlaygroundExecutionParameters, IDEPlaygroundLaunchDescriptor, IDEPlaygroundPreparationParameters, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSString;
