...
@class DVTBorderedView, GPURenderBuffer, GPURenderBufferBezeledLabel, GPURenderBufferCanvasGrid, GPUTraceAPIItem, GPUTraceFramebufferItem, GPUTraceFramebufferSubEditorCancelToken, NSArray, NSImage, NSLayoutConstraint, NSMenu, NSMenuItem, NSMutableIndexSet, NSObject, NSSegmentedControl, NSString, NSTextField;
