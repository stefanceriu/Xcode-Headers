...
@class DTDKRemoteDeviceConnection, DTDKRemoteDeviceConsoleController, DTDKTCPRelayProcess, DVTDispatchLock, DVTNotificationToken, DVTPlatform, NSArray, NSError, NSMutableArray, NSNumber, NSSet, NSString;
...
+ (id)keyPathsForValuesAffectingDeviceMountPort;
+ (id)keyPathsForValuesAffectingDeviceSSHPort;
+ (id)keyPathsForValuesAffectingDeviceNFSPort;
