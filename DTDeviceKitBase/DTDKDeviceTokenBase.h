...
#import "DTDKRemoteDeviceToken_Private.h"
...
@property(readonly, copy, nonatomic) NSArray *connections; // @synthesize connections;
...
@property(readonly) long long deviceMountPort; // @synthesize deviceMountPort;
@property(readonly) long long deviceSSHPort; // @synthesize deviceSSHPort;
@property(readonly) long long deviceNFSPort; // @synthesize deviceNFSPort;
...
@property(readonly) _Bool deviceIsPaired; // @synthesize deviceIsPaired;
...
@property(readonly, copy, nonatomic) NSNumber *deviceProductionSOC; // @synthesize deviceProductionSOC;
